...
return  array(
    ...
    /* 自定义参数 */
    'PWD_SALT'  => 'fengchao159753',    //用户密码盐
    'PAGE_THEME' => "<ul class='pagination'></li><li>%FIRST%</li><li>%UP_PAGE%</li><li>%LINK_PAGE%</li><li>%DOWN_PAGE%</li><li>%END%</li><li><span> %HEADER%  %NOW_PAGE%/%TOTAL_PAGE% 页 </span></li></ul>",
    'MAIN_DOMAIN'   =>'139.224.27.12',

	/* 平台方RBAC配置 */
	'USER_AUTH_ON'			=> true,		//是否需要认证
    'USER_AUTH_TYPE'        => 1,       	//认证类型
	'USER_AUTH_KEY'			=> 'alogin', 		//认证识别号   登陆为true 否则没有or为false
    'USER_AUTH_DATA'         => 'adata',      //认证识别号  平台用户登陆信息存放
	'REQUIRE_AUTH_MODULE'   => '',  		//需要认证模块
    'NOT_AUTH_MODULE'		=> 'Auth',  	//无需认证模块
	'USER_AUTH_GATEWAY'		=> '/Auth/Login/user',	  //认证网关
	'RBAC_ROLE_TABLE' 		=> 'a_role',    //角色表名称
	'RBAC_USER_TABLE'		=> 'a_role_user', 	//用户角色表，不是用户表, 此处是个大坑..
	'RBAC_ACCESS_TABLE'		=> 'a_access', 	//权限表名称
	'RBAC_NODE_TABLE' 		=> 'a_node',	//节点表名称
	
	/* IFA方RBAC配置 */
	'AGENT_USER_AUTH_ON'			=> true,		//是否需要认证
    'AGENT_USER_AUTH_TYPE'          => 1,       	//认证类型
	'AGENT_USER_AUTH_KEY'			=> 'ifalogin', 	//认证识别号   登陆为true 否则没有or为false
    'AGENT_USER_AUTH_DATA'           => 'ifadata',  //认证识别号  平台用户登陆信息存放
	'AGENT_REQUIRE_AUTH_MODULE'   	=> '',  		//需要认证模块
    'AGENT_NOT_AUTH_MODULE'			=> 'Auth',  	//无需认证模块
	'AGENT_USER_AUTH_GATEWAY'		=> '/Auth/Login/user',	  //认证网关
	'AGENT_RBAC_ROLE_TABLE' 		=> 'b_agent_role',    //角色表名称
	'AGENT_RBAC_USER_TABLE'			=> 'b_agent_role_user', 	//用户角色表
	'AGENT_RBAC_ACCESS_TABLE'		=> 'b_agent_access', 	//权限表名称
	'AGENT_RBAC_NODE_TABLE' 		=> 'b_agent_node',	//节点表名称
