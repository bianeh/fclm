...
use Train\Model\ARiskinviteModel;
class RiskinviteController extends Controller {
    protected $instance = NULL;
    public function __construct()
    {
        parent::__construct();
        if($this->instance == NULL) {
            $this->instance = new ARiskinviteModel;
        }
    }
    /**
     * 题库管理主页面
    ...
    public function invite()
    {
        ...
        if($result && $res)
        {
            return $this->success('邀请成功！',U('Train/Riskinvite/index'));
        }
        else{
            return $this->error('邀请失败！',U('Train/Riskinvite/index'));
        }
